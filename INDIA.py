...
from highcharts_core.options.series.map import MapSeries
from highcharts_core.options.series.data.map import MapData
...
from highcharts_core.options.maps import MapOptions
